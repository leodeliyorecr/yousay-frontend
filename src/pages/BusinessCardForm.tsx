      ...
      <div className={styles.form}>
        <div className={styles.section}>
          ...
          <div className={styles.field}>
            ...
            <input name="fullName" value={form.fullName} onChange={handleChange} placeholder={t('businessCardForm.placeholderName')} maxLength={60} />
          </div>
          <div className={styles.field}>
            <label>{t('businessCardForm.jobTitle')}</label>
            <input name="jobTitle" value={form.jobTitle} onChange={handleChange} placeholder={t('businessCardForm.placeholderJob')} maxLength={40} />
          </div>
          <div className={styles.field}>
            <label>{t('businessCardForm.company')}</label>
            <input name="company" value={form.company} onChange={handleChange} placeholder={t('businessCardForm.placeholderCompany')} maxLength={50} />
          </div>
        </div>
        <div className={styles.section}>
          ...
          <div className={styles.field}>
            ...
            <input name="email" value={form.email} onChange={handleChange} placeholder={t('businessCardForm.placeholderEmail')} maxLength={60} />
          </div>
          <div className={styles.field}>
            <label>{t('businessCardForm.website')}</label>
            <input name="website" value={form.website} onChange={handleChange} placeholder={t('businessCardForm.placeholderWebsite')} maxLength={60} />
          </div>
        </div>
        <div className={styles.section}>
          ...
          <div className={styles.field}>
            ...
            <input name="linkedin" value={form.linkedin} onChange={handleChange} placeholder={t('businessCardForm.placeholderSocial')} maxLength={40} />
          </div>
          <div className={styles.field}>
            <label>Facebook</label>
            <input name="facebook" value={form.facebook} onChange={handleChange} placeholder={t('businessCardForm.placeholderSocial')} maxLength={30} />
          </div>
          <div className={styles.field}>
            <label>Instagram</label>
            <input name="instagram" value={form.instagram} onChange={handleChange} placeholder={t('businessCardForm.placeholderSocial')} maxLength={30} />
          </div>
          <div className={styles.field}>
            <label>Twitter / X</label>
            <input name="twitter" value={form.twitter} onChange={handleChange} placeholder={t('businessCardForm.placeholderSocial')} maxLength={30} />
          </div>
          <div className={styles.field}>
            <label>TikTok</label>
            <input name="tiktok" value={form.tiktok} onChange={handleChange} placeholder={t('businessCardForm.placeholderSocial')} maxLength={30} />
          </div>
          <div className={styles.field}>
            <label>YouTube</label>
            <input name="youtube" value={form.youtube} onChange={handleChange} placeholder={t('businessCardForm.placeholderSocial')} maxLength={30} />
          </div>
        </div>
        <div className={styles.section}>
          ...
          <div className={styles.field}>
            ...
            <input name="address" value={form.address} onChange={handleChange} placeholder={t('businessCardForm.placeholderAddress')} maxLength={100} />
          </div>
          <div className={styles.fieldRow}>
            <div className={styles.field}>
              <label>{t('businessCardForm.latitude')}</label>
              <input name="latitude" type="number" step="0.0001" value={form.latitude} onChange={handleChange} placeholder={t('businessCardForm.placeholderLat')} />
            </div>
            <div className={styles.field}>
              <label>{t('businessCardForm.longitude')}</label>
              <input name="longitude" type="number" step="0.0001" value={form.longitude} onChange={handleChange} placeholder={t('businessCardForm.placeholderLng')} />
            </div>
          </div>
        </div>
